...
class CarTypeDAO extends BaseDAO implements IDAO {
    ...
    public function create(IModel $model) {
         ...
         $binds = array( ":cartype" => $model->getCartype(),
                          ":active" => $model->getActive()
                    );
                         
         if ( !$this->idExisit($model->getCartypeid()) ) {
             
             $stmt = $db->prepare("INSERT INTO cartype SET cartype = :cartype, active = :active");
     ...
     public function update(IModel $model) {
         ...
         $binds = array( ":cartype" => $model->getCartype(),
                          ":active" => $model->getActive(),
                          ":cartypeid" => $model->getCartypeid()
                    );
         
                
         if ( $this->idExisit($model->getCartypeid()) ) {
            
             $stmt = $db->prepare("UPDATE cartype SET cartype = :cartype, active = :active WHERE cartypeid = :cartypeid");
    ...
    public function delete($id) {
        ...
        $db = $this->getDB();         
        $stmt = $db->prepare("Delete FROM cartype WHERE cartypeid = :cartypeid");
